    ...
    public void testConcurrentClientSessionAddition() throws IOException, URISyntaxException, InterruptedException {
        ...
        try {
            ...
            IntStream.range(0, 3).parallel().forEach(i -> {
                ...
                System.out.println(clientId + " - " + clientIdToId.get(clientId));
                ...
                try {
                    ...
                    System.out.println((((keycloakClient == DC_1.kc()) ? "dc1 - " : "dc2 - ") + clientId + " - ") + stringObjectMap.get("access_token"));
                } catch (Throwable e) {
                    failureCounter.incrementAndGet();
                    System.out.println("---------------------------------------------------------------");
                    System.out.print((((keycloakClient == DC_1.kc()) ? "dc1 - " : "dc2 - ") + clientId + " - "));
                    e.printStackTrace();
